...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.navigation_frame_label = customtkinter.CTkLabel(self.sidebar_frame, text="  TEST", image=self.logo_image,
        ...
        self.guide_button = customtkinter.CTkButton(self.sidebar_frame, corner_radius=0, height=40, border_spacing=10, text="Hướng dẫn sử dụng",
                                                   fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"),
        ...
        self.tabview.tab("Chức năng").grid_columnconfigure(
        ...
        self.string_input_button = customtkinter.CTkButton(self.tabview.tab("Chức năng"), text="Open CTkInputDialog",
        ...
        self.textbox.insert("0.0", "Hướng dân sử dụng")
        self.textbox.configure(state="disabled", text_color="yellow")
    ...
    def select_frame_by_name(self, name):
        ...
        self.guide_button.configure(
            fg_color=("gray75", "gray25") if name == "guide" else "transparent")
    ...
    def home_button_event(self):
        ...
        self.radio_button_3.configure(state="disabled")
        self.appearance_mode_optionemenu.set("Dark")
        self.scaling_optionemenu.set("12%")
        # self.optionmenu_1.set("CTkOptionmenu")
        # self.combobox_1.set("CTkComboBox")
        self.slider_1.configure(command=self.progressbar_2.set)
        self.slider_2.configure(command=self.progressbar_3.set)
    ...
    def guide_button_event(self):
        ...
        # self.guide = customtkinter.CTkLabel(self.sidebar_frame, text="CTkLabel on Tab 2")
        ...
        self.progressbar_1.configure(mode="indeterminnate")
        self.progressbar_1.start()
        self.textbox.insert("0.0", "Thấy là may rồi")
        self.textbox.configure(state="disabled", text_color="yellow")
